...
import { DecodeError, ConfigurationSetNotFoundError } from './error'
...
describe('configuration manager', () => {
  ...
  describe('getConfigSet', () => {
    it('should return entire config set when empty namespace supplied', async () => {
    ...
    it('should return subset of configuration when matching namespace supplied', async () => {
      const expected = {
        region: 'us-east-1',
        poolId: 'us-east-1_ZiPDToF73',
        clientId: '120q904mra9d5l4psmvdbrgm49',
    ...
    it('should return nothing when no matching namespace supplied', async () => {
      const configSet = DefaultConfigurationManager.getInstance()
        .setConfig(JSON.stringify(config))
  ...
  describe('bindConfigSet<T>', () => {
    it('should find config set then bind to given type', async () => {
    ...
    it('should throw when configuration set not found', async () => {
      expect(() => {
    ...
    it('should still bind when no nampespace provided', async () => {
      const result = DefaultConfigurationManager.getInstance()
        .setConfig(JSON.stringify(config))
  ...
  describe('bind<T>', () => {
    it('should bind configuration set to a type', async () => {
      const expected = {
        region: 'us-east-1',
        poolId: 'us-east-1_ZiPDToF73',
        clientId: '120q904mra9d5l4psmvdbrgm49',
